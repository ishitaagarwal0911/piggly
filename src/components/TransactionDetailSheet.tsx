...
export const TransactionDetailSheet = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex flex-col h-screen max-h-screen w-full max-w-full m-0 p-0 rounded-none shadow-none outline-none border-0 animate-fade-in" hideClose={true}>
